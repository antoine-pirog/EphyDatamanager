...
def read_header(fid, verbose=True):
    ...
    vbprint(verbose, '')
    vbprint(verbose, 'Reading Intan Technologies RHD2000 Data File, Version {}.{}'.format(version['major'], version['minor']))
    vbprint(verbose, '')
    ...
    vbprint(verbose, 'n signal groups {}'.format(number_of_signal_groups))

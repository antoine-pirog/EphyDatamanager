...
def read_data(filename):
    ...
    if data_present:
        ...
        data['amplifier_data_raw'] = np.zeros([header['num_amplifier_channels'], num_amplifier_samples], dtype=np.uint) # AP 20191025
    ...
    if (data_present):
        ...
        data['amplifier_data_raw'] = 1. * data['amplifier_data'] # AP 20191025 (save raw data)
        ...
        if header['notch_filter_frequency'] > 0:
            ...
            for i in range(header['num_amplifier_channels']):
                ...
                progressbar.inlineCycles(i, header['num_amplifier_channels'], prefix="Applying notch filter :") # AP
